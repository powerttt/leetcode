...
public class SuperPow {
    ...
    public static int superPow(int a, int[] b) {
        ...
        int sb = Integer.parseInt(s.toString());

        result = (int) Math.pow(a, sb);
